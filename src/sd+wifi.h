...
void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title>Altitude Control System (ACS) Far Horizons</title>"); // NOTE: 1em = 16px
  webpage += F("<meta name='viewport' content='user-scalable=yes,initial-scale=1.0,width=device-width'>");
  webpage += F("<style>");
  webpage += F("body{max-width:65%;margin:0 auto;font-family:arial;font-size:105%;text-align:center;color:black;background-color:#fff8e0;}");
  webpage += F("ul{list-style-type:none;margin:0.1em;padding:0;border-radius:0.375em;overflow:hidden;background-color:#FFCE33;font-size:1em;}");
  ...
  webpage += F("h1{color:404041;border-radius:0.5em;font-size:1.5em;padding:0.2em 0.2em;background:#FFCE33;}");
  webpage += F("h2{color:orange;font-size:1.0em;}");
  webpage += F("h3{color:FFCE31; font-size:0.8em;}");
  ...
  webpage += F(".rcorners_n {border-radius:0.5em;background:#404041;padding:0.3em 0.3em;width:20%;color:white;font-size:75%;}");
  webpage += F(".rcorners_m {border-radius:0.5em;background:#404041;padding:0.3em 0.3em;width:50%;color:white;font-size:75%;}");
  webpage += F(".rcorners_w {border-radius:0.5em;background:#404041;padding:0.3em 0.3em;width:70%;color:white;font-size:75%;}");
  ...
  webpage += F("button{border-radius:0.5em;background:#404041;padding:0.3em 0.3em;width:20%;color:white;font-size:130%;}");
  webpage += F(".buttons {border-radius:0.5em;background:#404041;padding:0.3em 0.3em;width:15%;color:white;font-size:80%;}");
  webpage += F(".buttonsm{border-radius:0.5em;background:#404041;padding:0.3em 0.3em;width:9%; color:white;font-size:70%;}");
  webpage += F(".buttonm {border-radius:0.5em;background:#404041;padding:0.3em 0.3em;width:15%;color:white;font-size:70%;}");
  webpage += F(".buttonw {border-radius:0.5em;background:#404041;padding:0.3em 0.3em;width:40%;color:white;font-size:70%;}");
  webpage += F("a{font-size:75%;}");
  webpage += F("p{font-size:75%;}");
  webpage += F("</style></head><body><h1><p style=font-size:1em>Adler Planetarium | Far Horizons</p>Altitude Control System (ACS)");
  // webpage += F("<img src=Adler_Logo_lockup_RGB-2.png>"); // TODO Attempting to place logo on html page.
  webpage +=  "</h1>";
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
